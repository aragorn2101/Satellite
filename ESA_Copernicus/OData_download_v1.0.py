...
#  Build URL for querying the Copernicus database for the data
...
OutputFilename = query_df['Name'].iloc[0] + ".zip"
url_data = "https://zipper.dataspace.copernicus.eu/odata/v1/Products({:s})/$value".format(query_df['Id'].iloc[0])
